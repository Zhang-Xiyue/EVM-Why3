...
\begin{figure*}[t]
  \centering
  \resizebox{0.8\textwidth}{!}{
  \includegraphics{runninginPE.pdf}
  }
...
proof sessions can be found at \url{https://github.com/Xiyue-Selina/coordination20}.
}
...
corresponding bidder. Bidders can call \texttt{withdraw} function to get the money/Ether back.
(3)~The auction is ended by function \texttt{auctionEnd}. If current time is over the auctionEndTime,
...
Complete specification of the three functions can be found at \url{https://github.com/Xiyue-Selina/coordination20}. 
...
\noindent\textbf{Testing and Debugging.}~The \texttt{hevm} project~\cite{hevm} is implemented in Haskell for unit testing and debugging smart contracts.
